...
Run from the amtb/ directory (CWD-relative, matching the other wiki tools).
"""
...
BLOB_BASE = "https://github.com/l2yao/amtb/blob/main/amtb/"
TREE_BASE = "https://github.com/l2yao/amtb/tree/main/amtb/"
CDN_BASE = "https://tw4.hwadzan.info/redirect/media/"

PAGE_RE = re.compile(r"^\d{2}-\d{3}\.md$")
